...
# 20. FIRST MILESTONE: DISCOVERY AND PROJECT DEFINITION

Do not begin full implementation during the first milestone.

Complete the following sequence.

## Step 1: Inspect the available project environment
...
- its severity
- its likely cause
- whether it should be retained, revised, replaced, or removed

---

## Step 3: Prepare a Figma audit request for ChatGPT

Create a precise handoff asking ChatGPT to inspect the connected Figma design.

The request must ask ChatGPT to identify:
...
The output should be suitable for inclusion in FIGMA_AUDIT.md and TASTE.md.

---

## Step 4: Define the product vision

Convert all available evidence into:
...
## Step 6: Define the technical direction

After inspecting the existing codebase, recommend:

- whether to refactor or rebuild
...
Create phased milestones such as:
...
- about and professional credibility
- writing or article experience
...
## Step 9: Prepare Sprint 1

Sprint 1 should focus on validated foundations rather than visually impressive but unstable implementation.

A likely first sprint may include:
...
Only include work supported by discovery findings.

---

## Step 10: Present the project initiation package

Before assigning implementation work, produce:
...
8. Initial backlog
9. Sprint 1 proposal
10. Figma-review request for ChatGPT
11. First implementation task for Codex
12. QA plan
13. Decisions requiring my input

Do not generate large implementation changes until this initiation package is complete.

---

# 21. CODEX TASK TEMPLATE

Use this template whenever assigning work to Codex.
...
# 22. CHATGPT QA HANDOFF TEMPLATE

Use this template whenever requesting ChatGPT review.
...
[What decision ChatGPT must make]
